...
namespace Regular {
    ...
    class MainClass {
        ...
        public static BigInteger[] Regular(int n, int[] a) {
        ...
        public static void Main(string[] args) {
            foreach (int[] primes in new int[][] { new int[] {2,3,5}, new int[] {2,3,5,7} }) {
                ...
                Console.WriteLine(string.Join(" ", Regular(20, primes)));
                Console.WriteLine(Regular(1691, primes).Last());
                Console.WriteLine(Regular(1000000, primes).Last());
                Console.WriteLine();
            }
        }
    }
